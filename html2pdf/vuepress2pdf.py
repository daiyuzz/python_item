...
class DownloadVuePress2Pdf:
    ...
    def get_content_and_next_url(self, content):
        ...
        # 下载图片加上前缀地址
        base_url = "http://119.3.200.75:8094"
        bs = soup.find_all("img")
        for item in bs:
...
down = DownloadVuePress2Pdf("http://119.3.200.75:8094/", "vuepress指南",
                            wkhtmltopdf="D:\\tools1\\wkhtmltox\\bin\\wkhtmltopdf.exe", save_html_path="./files", save_pdf_path='./out')
